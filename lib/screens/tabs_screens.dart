...
import 'package:firebasetodoapps/screens/pending_screens.dart';
...
class _TabsScreenState extends State<TabsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: _selectedPageIndex==0? FloatingActionButton(onPressed: () =>_addTask(context),
        tooltip: 'Add Task',shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(21)),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const[
          BottomNavigationBarItem(icon: Icon(Icons.incomplete_circle_sharp),
          label: 'Pending Tasks'),
